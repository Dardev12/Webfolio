...
<div class="foo text-center"><h1>Présentation :</h1></div>
<br>
<div class="container">
    <div class="row">
        <div class="iphoto col-sm-4 pt-3 pb-3 pl-3 pr-3">
...
<div class="foo jumbotron text-center w3-indigo">
    <h2>Mes créations:</h2><br>
    <div class="row ">
        ...
        <div class="iphoto container-fluid col-sm-3 ">
          <p><b>Voir plus..</b></p>
          <a href="index.php?action=portefolio">
            <img src="img\add.png" class="center-block img-responsive rounded-circle" style="width:100%" alt="Image">
          </a>
        </div>     
    </div>
    </div><br>
...
<div class="container" style="margin-top:30px">
  ...
  <!--Colonne de gauche-->
    <div class="col-sm-4 sidenav">
      ...
      <div class="bar w3-indigo rounded pt-3 pb-3 pl-3 pr-3">
    ...
    <div class="col-sm-8">
      ...
      <div class="foo w3-white rounded pt-5 pb-5 pl-5 pr-5">
          <h2>Compétences Techniques :</h2>
            <p><img class="iphoto" src="img\icons8-kotlin-480.png" style="width:15%;"> Kotlin</p>
            ...
            <br>
            <p><i class="iphoto fab fa-fw fa-trello" style="font-size: 6rem;"></i> Trello</p>
            <div class="w3-grey w3-round-xlarge">
              <div class="lvl w3-round-xlarge w3-container w3-blue w3-padding w3-center" style="width:80%">80%</div>
            </div>
      </div>
      ...
      <div class="foo w3-indigo rounded pt-5 pb-5 pl-5 pr-5">
        <h2>Qualité :</h2>
          <ul><b>
            <li>Autoditacte</li>
            <br>
